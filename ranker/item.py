...
class Item:
    ...
    def get_g(self):
        ...
        return 1 / math.sqrt(
            1 + (3 * (self.Q**2) * (self.variance**2)) / math.pi**2
        )
    ...
    def get_d2(self, other):
        ...
        expected_score = self.get_expected_score(other)

        return 1 / (
            self.Q**2 * (other.get_g() ** 2) * expected_score * (1 - expected_score)
        )
    ...
    def get_expected_score(self, other):
        ...
        return 1 / (1 + 10 ** (self.get_g() * (other.rating - self.rating) / 400))
    ...
    def get_new_rating(self, score, other):
        ...
        return self.rating + self.Q / (
            1 / self.variance**2 + 1 / self.get_d2(other)
        ) * other.get_g() * (score - self.get_expected_score(other))
    ...
    def get_new_variance(self, other):
        ...
        return 1 / math.sqrt(1 / self.variance**2 + 1 / self.get_d2(other))
